...
//When you set this.password, the value is actually stored in a private property _password. This ensures that the internal representation of the password can be different from what is publicly accessible.